...
/**
 * This is {@link org.apereo.cas.CasEmbeddedContainerUtils}.
 *
...
public final class CasEmbeddedContainerUtils {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apereo.cas.CasEmbeddedContainerUtils.class);
    ...
    public static Banner getCasBannerInstance() {
        final String packageName = org.apereo.cas.CasEmbeddedContainerUtils.class.getPackage().getName();
