...
public interface TagApi {
    ...
    Result<List<TagModel>> batchGetTags(Set<String> tagIdList);


    /**
     * 分页获取标签
     * @param targetList  标签分类集合
    ...
    Result<List<TagModel>> GetTagsByPage(List<Integer> targetList, Integer currentPage, Integer pageSize);
