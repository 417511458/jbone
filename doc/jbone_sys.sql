...
CREATE TABLE `rbac_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='角色';

-- ----------------------------
--  Records of `rbac_role`
-- ----------------------------
BEGIN;
INSERT INTO `rbac_role` VALUES ('8', 'sso', '单点登录', '单点登录', '1', '2018-02-02 16:46:59', '2018-02-02 16:46:59', '1'), ('9', 'serverAdministrator', '服务管理员', '服务管理员', '1', '2018-02-02 16:46:59', '2018-02-02 16:46:59', '1'), ('10', 'admin', '系统管理员', '系统管理员', '1', '2018-02-02 16:46:59', '2018-03-25 19:01:06', '10'), ('11', 'casAdministrator', '单点登录认证管理员', '用于管理CASManager', '0', '2018-03-30 11:18:27', '2018-03-30 11:19:05', '1'), ('12', 'ebAdministrator', '电商平台管理员', '电商平台管理员', '0', '2018-04-03 20:04:05', '2018-04-12 16:49:57', '3'), ('13', 'bpmAdministrator', '工作流管理员', '工作流管理员', '0', '2018-04-21 16:24:23', '2018-04-21 16:24:37', '1');
COMMIT;
...
CREATE TABLE `rbac_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='角色-菜单关系表';

-- ----------------------------
--  Records of `rbac_role_menu`
-- ----------------------------
BEGIN;
INSERT INTO `rbac_role_menu` VALUES ('46', '10', '21'), ('47', '10', '22'), ('48', '10', '23'), ('49', '10', '24'), ('50', '10', '25'), ('51', '10', '26'), ('52', '10', '30'), ('53', '10', '31'), ('54', '10', '32'), ('55', '10', '35'), ('56', '12', '36'), ('57', '12', '37'), ('58', '12', '38'), ('59', '12', '39'), ('60', '12', '41'), ('61', '12', '42'), ('62', '12', '43'), ('63', '12', '44'), ('64', '12', '45'), ('65', '13', '46'), ('66', '13', '47'), ('67', '13', '48'), ('68', '13', '49'), ('69', '13', '50'), ('70', '13', '51'), ('71', '13', '52'), ('72', '13', '53'), ('73', '13', '54'), ('74', '13', '55');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `rbac_user` VALUES ('14', 'test123', 'test', '1231111', '123', '123fff', '123', '1', '1', '2018-02-01 09:31:47', '2018-03-21 09:20:09', '2', null), ('24', 'jbone', '49a12ae5ed3a17e04e9837bae71da54e', '渔樵', 'http://majunwei.com/logo.png', '1', '1', '1', '1', '2018-02-01 09:31:47', '2018-04-21 16:24:48', '26', '1521896490652'), ('25', 'test1', 'eedcca02294e4519f834984df8ec5939', 'test1', '', '111', '', '1', '0', '2018-02-27 21:47:53', '2018-02-27 21:59:54', '3', null), ('28', 'salt', '97d993a9e0c5ba68c86570350c6cd7bf', '测试Salt', '', '', '', '1', '0', '2018-03-22 22:15:16', '2018-03-24 17:52:21', '2', '1521885141059'), ('30', 'test77', '5ebb7bad80b2250d14df6759e91487ac', '测试修改密码', '', '', '', '1', '0', '2018-03-24 17:01:02', '2018-03-25 22:26:15', '7', '1521987975171'), ('31', 'rrr', '76006b9c3e170001fef5e78853b5fbdc', 'rrr', '', '', '', '1', '0', '2018-03-30 16:02:50', '2018-03-30 16:02:50', '0', '1522396970429');
COMMIT;
...
CREATE TABLE `rbac_user_permission` (
  ...
  `permission_id` int(10) unsigned NOT NULL COMMENT '权限编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COMMENT='用户权限关联表';

-- ----------------------------
--  Records of `rbac_user_permission`
-- ----------------------------
BEGIN;
INSERT INTO `rbac_user_permission` VALUES ('40', '24', '124'), ('41', '24', '125'), ('42', '24', '126'), ('43', '24', '127'), ('44', '24', '93'), ('45', '24', '96'), ('46', '24', '97'), ('47', '24', '98'), ('48', '24', '99'), ('49', '24', '100');
COMMIT;
...
CREATE TABLE `rbac_user_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COMMENT='用户角色关联表';

-- ----------------------------
--  Records of `rbac_user_role`
-- ----------------------------
BEGIN;
INSERT INTO `rbac_user_role` VALUES ('4', '1', '1'), ('5', '1', '2'), ('6', '2', '1'), ('7', '2', '2'), ('49', '25', '8'), ('50', '25', '9'), ('51', '25', '10'), ('54', '28', '8'), ('55', '28', '9'), ('56', '28', '10'), ('63', '30', '8'), ('64', '30', '9'), ('65', '30', '10'), ('75', '24', '8'), ('76', '24', '9'), ('77', '24', '10'), ('78', '24', '11'), ('79', '24', '12'), ('80', '24', '13');
COMMIT;
