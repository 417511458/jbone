...
@EnableJpaRepositories(entityManagerFactoryRef="entityManagerFactory",transactionManagerRef="transactionManager",basePackages= {"com.majunwei.jbone.sys.dao.repository"})
public class RepositoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryDecorate (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.majunwei.jbone.sys.dao.domain") //设置实体类所在位置
