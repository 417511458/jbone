package cn.jbone.sys.core.dao.config;
...
@EnableJpaRepositories(entityManagerFactoryRef="entityManagerFactory",transactionManagerRef="transactionManager",basePackages= {"cn.jbone.sys.core.dao.repository"})
public class RepositoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryDecorate (EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("cn.jbone.sys.core.dao.domain") //设置实体类所在位置
